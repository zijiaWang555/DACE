...
def get_stats_arg_parser():
    ...
    parser.add_argument('--data', type=str, default='STATS-light',
                        help='')

    # ----------------------------------- Data Path Params -----------------------------------
    parser.add_argument('--base_dir', type=str, default='../data/STATS-light/',
                        help='')
    parser.add_argument('--absolute_base_dir', type=str,
                        default='$WORKSPACE_DIR$/data/STATS-light',
                        help='')
    parser.add_argument('--data_dir', type=str, default='../data/STATS-light/data/', #STATS-light STATS-light STATS-light
                        help='data dir')
    parser.add_argument('--workload_base_dir', type=str, default='../data/STATS-light/workload/',
                        help='')
    ...
    parser.add_argument('--experiments_dir', type=str, default='./exp12/alece_teacher_max_STATS-light/',                  #####
                        help='Directory to put the experimental results.')
    parser.add_argument('--gpu', type=int, default=0, help='')                                         ############   GPU
    #parser.add_argument('--batch_size', type=int, default=512)
    parser.add_argument('--batch_size', type=int, default=256)
    parser.add_argument('--n_epochs', type=int, default=150, help='Number of epochs.')                ###########  E
    ####################################################################################################################################################  bigermax
    # parser.add_argument('--mlp_hidden_dim', type=int, default=1024,help='number of neurons in a mlp layer.')
    # parser.add_argument('--num_attn_heads', type=int, default=12, help='')
    # parser.add_argument('--attn_head_key_dim', type=int, default=1023, help='')
    # parser.add_argument('--feed_forward_dim', type=int, default=2048, help='')
    ####################################################################################################################################################  bigmax
    parser.add_argument('--mlp_hidden_dim', type=int, default=512,help='number of neurons in a mlp layer.')
    parser.add_argument('--num_attn_heads', type=int, default=10, help='')
    parser.add_argument('--attn_head_key_dim', type=int, default=1023, help='')
    parser.add_argument('--feed_forward_dim', type=int, default=2048, help='')
    ###################################################################################################################################################  med
    # parser.add_argument('--mlp_hidden_dim', type=int, default=512,help='number of neurons in a mlp layer.')
    ...
    # parser.add_argument('--feed_forward_dim', type=int, default=2048, help='')
    ####################################################################################################################################################  stu
    # parser.add_argument('--mlp_hidden_dim', type=int, default=127,help='number of neurons in a mlp layer.')
    # parser.add_argument('--num_attn_heads', type=int, default=8, help='')
    # parser.add_argument('--attn_head_key_dim', type=int, default=80, help='')
    # parser.add_argument('--feed_forward_dim', type=int, default=80, help='')
    ####################################################################################################################################################
    ...
    parser.add_argument('--db_data_dir', type=str, default='', help='')
    # parser.add_argument('--db_data_dir', type=str, default='/var/lib/postgresql/12/main/', help='')
