...
class JoinOrderBenchmark(object):
    ...
    TRUE_FULL_OUTER_CARDINALITY = {
        ...
        ('cast_info', 'movie_companies', 'movie_info',\
         'movie_info_idx', 'movie_keyword', 'title'): 2128877229383, #job1
        #  'movie_info_idx', 'movie_keyword', 'title'): 2125114726883, #job2
        # 'movie_info_idx', 'movie_keyword', 'title'): 3762502500, #job3
