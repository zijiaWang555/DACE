...
class VEGASMap:
    ...
    def get_Y(self, x):
        ...
        for d in range(self.dim):
            ...
            # print("dimension [{}] edges are ".format(d))
            # print(self.x_edges.shape)
            # print(self.x_edges[d, :])
            # print("dimension [{}] xs are ".format(d))
